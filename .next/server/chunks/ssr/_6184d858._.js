...
"[project]/src/app/(pages)/Components/LoginPages/SignIn.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const SignIn = ()=>{
    ...
    const handalSingIn = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(authUrl, {
                identifier: identify,
                password: password
            });
            success();
...
//# sourceMappingURL=_6184d858._.js.map