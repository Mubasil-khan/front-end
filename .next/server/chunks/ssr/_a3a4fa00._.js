...
"[project]/src/app/(pages)/Components/LoginPages/SignUp.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const SignUp = ()=>{
    const [background, setBackground] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const success = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("🎉 Welcome back! You've logged in successfully.", {
            position: "top-right",
    ...
    const Alert = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("⚠️ Invalid entry! Please check your details.", {
            position: "top-right",
            className: "toast-message",
            autoClose: 2000,
            hideProgressBar: false,
    ...
    const handalSignup = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(RegisterUrl, {
                username: userName,
                email: email,
                password: password
            });
...
//# sourceMappingURL=_a3a4fa00._.js.map